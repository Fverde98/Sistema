				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-10em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1><center><BR> Control de Reservas </BR></h1>	
						</div>
					</div>
<center>
				...
				echo "<table border='10'; class='btn btn-primary';>";
					echo "<tr class='warning'>";
					   echo "<td><font color='000000' size='5'>Nombre<br></font></td>";
						echo "<td><font color='6D6D71' size='5'>Motivo<br></font></td>";
						echo "<td><font color='000000' size='5'>Telefono<br></font></td>";
						echo "<td><font color='6D6D71' size='5'>Hora<br></font></td>";
